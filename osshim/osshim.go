...
func (sh *OsShim) Executable() (string, error) {
...
func (sh *OsShim) Open(name string) (*os.File, error) {
	return os.Open(name)
}

func (sh *OsShim) Create(name string) (*os.File, error) {
...
func (sh *OsShim) NewFile(fd uintptr, name string) *os.File {
	return os.NewFile(fd, name)
}

func (sh *OsShim) OpenFile(name string, flag int, perm os.FileMode) (*os.File, error) {
...
func (sh *OsShim) Pipe() (r *os.File, w *os.File, err error) {
	return os.Pipe()
}
