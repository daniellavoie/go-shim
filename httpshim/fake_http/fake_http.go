...
func (fake *FakeHttp) Get(url string) (resp *http.Response, err error) {
	fake.getMutex.Lock()
...
func (fake *FakeHttp) GetArgsForCall(i int) string {
	fake.getMutex.RLock()
	defer fake.getMutex.RUnlock()
	return fake.getArgsForCall[i].url
}

func (fake *FakeHttp) GetReturns(result1 *http.Response, result2 error) {
	fake.GetStub = nil
...
func (fake *FakeHttp) GetReturnsOnCall(i int, result1 *http.Response, result2 error) {
	fake.GetStub = nil
...
var _ goshim.Http = new(FakeHttp)
